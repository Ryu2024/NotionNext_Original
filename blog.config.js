...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '36f7a580f78080e084a1c60048132a3b,en:36f7a580f78080e084a1c60048132a3b',
  THEME: process.env.NEXT_PUBLIC_THEME || 'utrecht', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 claude,endspace,example,fukasawa,fuwari,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  LANG: process.env.NEXT_PUBLIC_LANG || 'zh-CN', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  SINCE: process.env.NEXT_PUBLIC_SINCE || 1999, // e.g if leave this empty, current year will be used.
